...
let testQueries = [
  ...
  "SELECT EMP_ID, LAST_NAME FROM EMPLOYEE_TBL WHERE CITY = 'DETROIT' ORDER BY EMP_ID;",
  "SELECT EMP_ID, LAST_NAME FROM EMPLOYEE_TBL WHERE CITY = 'DETROIT' ORDER BY EMP_ID, LAST_NAME DESC;",
  "SELECT EMP_ID, LAST_NAME FROM EMPLOYEE_TBL WHERE CITY = 'DETROIT' ORDER BY 1;",
  "SELECT EMP_ID, LAST_NAME FROM EMPLOYEE_TBL WHERE CITY = 'DETROIT' ORDER BY 2, 1;",
